    ...
    */
    ...
    protected function setUp(): void
    {
        ...
        if (!self::$isDataInitialized) {
            ...
            echo "\n************ Initializing Attendance_through mock data *************\n";
            $r1 = Student::first();
            $r2 = $r1->attendance->first();
            if (!$r2->attendance_through()->exists()) {
                echo "*** Attendance_through records created.\n";
                $r2->attendance_through()->create([
                    'testfield'  => 'test ' . rand(1000, 9999),     
                ]);
                $r2->attendance_through()->create([
                    'testfield'  => 'test ' . rand(1000, 9999),     
                ]);
    ...
    public function testHasOneThrough(): void
    {
        ...
        try {
            $r1 = Student::first();
            $r2 = $r1->phone()->first(); // Fetch related Phone
            $r3 = $r2->idcard()->first(); // Use property-like access to fetch the related StudentIdCard
    ...
    {
        echo "\n********************* test one to many relationship - HasManyThrough *********************\n";
        echo "   hasManyThrough() \n";
        try {
            $r1 = Student::first();
